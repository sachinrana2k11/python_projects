...
from Gateway_Sensors.IO_SENSOR import MODBUS1
...
IO = MODBUS1()#IO sensor class object
#---------------------------------Init hardware class and define objects----------------------------
...
if __name__ == '__main__':
    ...
    #     i = i+1
     ...
     p2 = multiprocessing.Process(target=get_data_modbus) # 2nd process
     p3 = multiprocessing.Process(target=get_data_io_sensor) # 3rd process
